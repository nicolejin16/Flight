...
<table width="100%" style="border:2px solid #FFC107; border-radius:12px; margin:12px 0;">
  <tr>
    ...
    <td width="72%" style="padding:12px 16px;">
      ...
      <p style="margin-top:8px;">
        <b>About Me:</b> MY name is Summer, I am 16 years old. I love figure skating and drawing. I also do badminton and track and field for school. I starting coding when I was twelve years old and this is my second year doing WRO Future Engineers. 
      </p>
    </td>
  </tr>
</table>
...
| Arduino | [`Arduino Nano 33 BLE Rev2`] (
